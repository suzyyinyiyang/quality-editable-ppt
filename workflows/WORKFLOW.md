...
- Do not enumerate all tools or inspect automation tools during image-generation preflight.
- If real image generation is unavailable, stop before Gate 3 instead of using local fallback preview generation.
